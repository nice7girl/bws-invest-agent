...
Write-Host "======================================" -ForegroundColor Cyan
Write-Host "1. 오전 스케줄: 매일 08:40"
Write-Host "2. 오후 스케줄: 매일 17:40"
Write-Host ""
